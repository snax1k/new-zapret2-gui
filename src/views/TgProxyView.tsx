    ...
    <div className="h-full flex flex-col p-6 space-y-4 overflow-y-auto select-none">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 max-w-3xl">
          ...
          а мост выводит соединение через веб-транспорт Telegram — тот самый, которым
          пользуется веб-версия. К обходу DPI отношения не имеет и работает отдельно:
          ядро может быть выключено.
        </p>
      </div>
      ...
      <div className={`p-4 rounded-xl border space-y-2 ${card}`}>
        ...
        <p className="text-[11px] text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          а наружу идёт по WebSocket к серверам веб-версии Telegram. Их адреса не в
          закрытых подсетях, и снаружи соединение выглядит как обычный заход на сайт.
        </p>
      </div>
    </div>
  );
